...
import { Calendar, TrendingDown, TrendingUp, History, Scale, FileText, CheckCircle2, Users } from "lucide-react";
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="space-y-2">
                            <div className="flex items-center gap-4">
                                ...
                                <CardTitle className="text-3xl font-black text-white tracking-tight uppercase">Historial Clínico</CardTitle>
                            </div>
